...
* **确认序号**(Acknowledgment Number):接收方在接收到数据后,会回复确认报文,其中就包含有确认序号,作用是为了告诉发送方自己接收到了哪些数据,下一次的数据从哪里开始发送,因此,ack序号应当是上次已成功收到的数据字节序号加1.只用ACK标志为1时确认序号字段才有效.
...
#### 2.1.1三次握手
  ...
  ![image-20240810160954877](./images/image-20240810160954877.png)
...
![image-20240810164451480](./images/image-20240810164451480.png)
